...
y_train = torch.tensor(migraine_labels[train_indices], dtype=torch.float32).unsqueeze(1)
...
y_val = torch.tensor(migraine_labels[val_indices], dtype=torch.float32).unsqueeze(1)
...
y_test = torch.tensor(migraine_labels[test_indices], dtype=torch.float32).unsqueeze(1)
